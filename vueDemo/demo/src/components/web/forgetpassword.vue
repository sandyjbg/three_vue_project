<template>
    <div class="wtf">
        <el-row>
            <el-col :span="24"><div class="grid-content bg-purple-dark2"><h1>找回你的JB账号</h1></div></el-col>
        </el-row>
        ...
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px"  label-position="left" class="demo-ruleForm">
            ...
            <el-form-item label="验证码" prop="name2">
                <el-input v-model="ruleForm.name2"></el-input>
            </el-form-item>
            
            <el-form-item label="你是真人？" prop="name2">
                <div class="s-canvas">
        ...
        return {
            ...
            rules: {
                name: [
                    ...
                    { max: 11, message: '长度在11个数字', trigger: 'blur' }
            ],
                name2: [
